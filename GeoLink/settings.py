"""
Django settings for GeoLink project.
...
dotenv_file = os.path.join(BASE_DIR, ".env") #Secret key is stored in gitignored .env file
...
WSGI_APPLICATION = 'GeoLink.wsgi.application'
